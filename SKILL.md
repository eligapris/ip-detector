...
1. Run `python /home/z/my-project/skills/ip-detector/scripts/extract_concepts.py <path>` to get a structured inventory of candidate concepts: algorithms, data structures, novel mechanisms, data flows, performance hacks, integration patterns.
...
```bash
python /home/z/my-project/skills/ip-detector/scripts/generate_dossier.py \
  --data <path-to-analysis.json> \
  --output /home/z/my-project/download/ip_dossier_<concept_slug>.pdf
```
...
Save the PDF to `/home/z/my-project/download/ip_dossier_<concept_slug>.pdf` and report the path to the user. Also save the raw analysis JSON alongside it as `ip_dossier_<concept_slug>.json` for re-runs.
